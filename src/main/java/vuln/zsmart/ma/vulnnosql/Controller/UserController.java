...
import vuln.zsmart.ma.vulnnosql.Services.SocialMediaService;
...
public class UserController {
    ...
    public String AddNew(User user, @RequestParam("image") MultipartFile img,RedirectAttributes redir)throws IOException
    {
            ...
            redir.addFlashAttribute("msgAddUser","User Has Been Added Successfully !");
            //model.addAttribute("msgAddUser",msg);
